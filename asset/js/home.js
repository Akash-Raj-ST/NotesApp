function hideRightClick(e){
    console.log("hide right click");
}
...
function open_section_edit(e){
    ...
    var sect_edit = e.parentNode.parentNode.parentNode.querySelector("#open-section-edit");
...
function body_click(except=null){
    ...
    if(except != 'open_add_course')
        hide_add_course();
    if(except != 'open_sect')
        hide_sect();
    if(except != 'open_form_sect')
        close_form_sect();
    if(except != 'right_click_course')
        hide_menu();    
